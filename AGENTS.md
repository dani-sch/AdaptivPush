...
| Documentation lifecycle | Follow `.github/instructions/documentation.instructions.md`: archive task-consumed or superseded temporary docs during the same task, preserve provenance, repair direct references, and update owning living docs in place. Ordinary closeout is task-scoped; broad audits require an explicit request or documentation-architecture refactor. |
