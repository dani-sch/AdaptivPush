...
export default function WorkoutHistoryScreen() {
  ...
  const summary = useMemo(() => {
    ...
    const totalMinutes = workoutHistory.reduce(
      (acc, workout) => acc + workout.durationMin,
      0,
    );
    ...
    return {
      ...
      readiness: Math.min(
        10,
        Number((4 + totalWorkouts * 0.7 + totalMinutes / 300).toFixed(1)),
      ).toFixed(1),
        ...
        {loading ? (
          ...
          >
            <View style={styles.nextWorkoutHeaderRow}>
              <View>
                ...
                <Text style={styles.nextWorkoutDuration}>
                  {nextWorkout.durationMin} min
                </Text>
              </View>
            ...
            <View style={styles.exerciseListWrap}>
              {getExercisePreview(nextWorkout).map((exercise) => (
                <View
                  key={`${nextWorkout.id}-${exercise.name}`}
          ...
          <View style={styles.stateCard}>
            ...
            <Text style={styles.stateText}>
              Complete a workout to populate this screen.
            </Text>
          </View>
        )}
          ...
          <View style={styles.modalCard}>
            ...
            {selectedWorkout && (
              <View style={styles.modalContent}>
                ...
                <Text style={styles.modalWorkoutDate}>
                  {detailDate(selectedWorkout.completedAt)}
                </Text>
                ...
                <View style={styles.detailRow}>
                  ...
                  <Text style={styles.detailValue}>
                    {selectedWorkout.split || "Not set"}
                  </Text>
                </View>
                <View style={styles.detailRow}>
                  <Text style={styles.detailLabel}>Notes</Text>
                  <Text style={styles.detailValue}>
                    {selectedWorkout.notes || "No notes for this workout."}
                  </Text>
                </View>
              </View>
            )}
