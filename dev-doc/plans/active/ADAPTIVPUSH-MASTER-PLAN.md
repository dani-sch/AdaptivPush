...
Current execution position: AP-01.3 and the AP-02/AP-03 hosted baseline are deployed, with normal local writer flags enabled under the September 15 authorization. Physical iPhone acceptance remains open. The completed-workout correction extension is released: migrations `20260915190000` and `20260915210000` were deployed under separate September 17 authorization after fresh recovery and drift checks. Authenticated hosted browser edit/cancel/save/reopen, all completed entry points, replay/conflict and ownership checks passed. [September 17 release evidence](/dev-doc/reports/ADAPTIVPUSH-EDIT-PAST-WORKOUT-RELEASE-2026-09-17.md) owns exact hashes, backup/restore, verification and remaining physical iPhone acceptance. Missing required work holds progression; broader AP-04/AP-05 remain queued.
