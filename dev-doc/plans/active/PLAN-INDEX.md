...
[TODO](/dev-doc/main/TODO.md) routes the immediate work. AP-01.1 read-only inspection and AP-01.2a lookup-only catalog compatibility are locally verified. AP-01.3 completed the production baseline/ledger, encrypted backup and local restore, cross-schema trigger reconciliation, isolated security suite, and production catalog enforcement on 2026-09-10. AP-02/AP-03 retain prior integration evidence behind default-off flags; the [September 14 packet](/dev-doc/reports/ADAPTIVPUSH-AP-02-AP-03-RELEASE-2026-09-14.md) owns current verification and integration. Secure CLI/database authentication is verified. User pre-migration device/accessibility passes precede fresh encrypted backup/restore and exactly two production migrations; real distribution identity, rollback rehearsal and monitoring additionally gate production writers. AP-04/AP-05 remain next only after that release boundary.
