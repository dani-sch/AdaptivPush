...
[TODO](/dev-doc/main/TODO.md) routes the immediate work. AP-01.1 read-only inspection and AP-01.2a lookup-only catalog compatibility are locally verified. AP-01.3 completed the production baseline/ledger, encrypted backup and local restore, cross-schema trigger reconciliation, isolated security suite, and production catalog enforcement on 2026-09-10. The [September 14 release packet, updated September 15](/dev-doc/reports/ADAPTIVPUSH-AP-02-AP-03-RELEASE-2026-09-14.md) records the deployed three-migration AP-02/AP-03 packet, encrypted recovery/restore proof and enabled writers in the normal local environment. The user's rollout instruction superseded earlier pre-migration manual/signing gates. Physical acceptance uses the existing account and ordinary Expo Go QR and remains open. The completed-workout correction extension is released: migrations `20260915190000` and `20260915210000` were deployed under separate September 17 authorization after fresh recovery and drift checks. Authenticated hosted browser edit/cancel/save/reopen, all completed entry points, replay/conflict and ownership checks passed. [September 17 release evidence](/dev-doc/reports/ADAPTIVPUSH-EDIT-PAST-WORKOUT-RELEASE-2026-09-17.md) owns exact hashes, backup/restore, verification and remaining physical iPhone acceptance. Missing required work holds progression; broader AP-04/AP-05 remain queued.
