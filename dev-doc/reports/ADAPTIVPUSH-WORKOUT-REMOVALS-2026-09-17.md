...
Final-set empty-state regression fix `fcda8bf` is integrated at `c2fc22e`; strict TypeScript, all 107 cases and lint passed again in that checkout. The database packet/hash is unchanged.
